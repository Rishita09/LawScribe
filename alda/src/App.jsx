...
import DeedOfLease from "./components/CreateLegalDoc/DeedOfLease";
import "./App.css";
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route
            path="/create-legal-doc/property-sale-agreement"
            element={<PropertySaleAgreement />}
          />
          <Route
            path="/create-legal-doc/employee-service-agreement"
            element={<EmployeeServiceAgreement />}
          />
          <Route
            path="/create-legal-doc/deed-of-lease"
            element={<DeedOfLease />}
          />
          <Route
            path="/create-legal-doc/restraining-order"
            element={<RestrainingOrder />}
          />
          <Route
            path="/create-legal-doc/gift-deed-for-giving-cash"
            element={<GiftDeed />}
          />
          <Route
            path="/create-legal-doc/mutual-divorce-petition"
            element={<MutualDivorcePetition />}
          />
